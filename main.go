...
func TryRecordCredit(accid, service, serviceId, itemType, itemId string, quantity int64, price float32) (bool, error) {
...
func RecordCredit(accid, service, serviceId, itemType, itemId string, quantity int64, price float32, data *header.CreditSendEntryData) {
